...
<tr>
 <td height="26">
  ...
  <td align="center">
    ...
    <input type='button' class="coolbg np" onClick="category_manager()" value='栏目管理' />
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" >&nbsp;文档列表&nbsp;</td>
</tr>
...
<table width='98%'  border='0' cellpadding='1' cellspacing='1' bgcolor='#CBD8AC' align="center" style="margin-top:8px">
  <tr bgcolor='#EEF4EA'>
    <td background='<?php echo base_url();?>/static/image/admin/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        ...
        <td>
          <input name="imageField" type="image" src="<?php echo base_url();?>/static/image/admin/search.gif" width="45" height="20" border="0" class="np" />
        </td>
       </tr>
      </table>
    </td>
